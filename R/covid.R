...
#'   \item{population_age_10_19}{Integer; Estimated population between the ages of 10 and 19, inclusive.}
#'   \item{population_age_20_29}{Integer; Estimated population between the ages of 20 and 29, inclusive.}
#'   \item{population_age_30_39}{Integer; Estimated population between the ages of 30 and 39, inclusive.}
#'   \item{population_age_40_49}{Integer; Estimated population between the ages of 40 and 49, inclusive.}
#'   \item{population_age_50_59}{Integer; Estimated population between the ages of 50 and 59, inclusive.}
#'   \item{population_age_60_69}{Integer; Estimated population between the ages of 60 and 69, inclusive.}
#'   \item{population_age_70_79}{Integer; Estimated population between the ages of 70 and 79, inclusive.}
#'   \item{population_age_80_and_older}{Integer; Estimated population ages 80 and over, inclusive.}
...
#'   \item{cumulative_persons_vaccinated}{Integer; Cumulative sum of persons which have received one or more doses}
#'   \item{new_persons_fully_vaccinated}{Integer; Count of new persons which have received all doses required for maximum immunity as of August 1st 2021}
